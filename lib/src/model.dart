...
class Anime extends MalBase {
  ...
  Anime({this.title, this.titleEnglish, this.titleJapanese, this.titleSynonyms,
      this.imageUrl, this.trailerUrl, this.type, this.source, this.episodes, this.status,
      this.airing, this.airingStart, this.aired, this.duration, this.rating, this.score,
      this.scoredBy, this.rank, this.popularity, this.members, this.favorites, this.synopsis,
      this.background, this.premiered, this.broadcast, this.related, this.producers,
      this.licensors, this.studios, this.genres, this.openingThemes, this.endingThemes,
      this.r18, this.kids, this.continued, this.characters, this.articles, this.episodeList,
      this.pictures, this.videos, this.stats, this.forum, this.moreInfo});
